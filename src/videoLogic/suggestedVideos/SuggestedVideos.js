  ...
  return (
    <div className="suggested-videos-section">
      ...
      <ul className="suggested-videos-list">
        {videos.map(video => (
          <li key={(video.id || video._id)} className="suggested-video-item">
            <Link to={`/video/${(video.id || video._id)}`} className="suggested-video-link">
              ...
              <div className="suggested-video-info">
                ...
                <div className="email-details">
                  {getUserByEmail && video.email && (
                    <span className="email-link" onClick={() => handleEmailClick(video.email)} style={{ cursor: 'pointer' }}>
